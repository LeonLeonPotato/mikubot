...
pros::Motor robot::wallmech(16); 
pros::Rotation robot::wallmech_encoder(-2);

pros::Imu robot::inertial(13);
pros::Optical robot::classifier(12);
pros::Rotation robot::side_encoder(-1);
pros::Rotation robot::back_encoder(11);
